const I18N = {
  de: {
    ...
    annualEstimateNote: "Bei unvollständigen Jahren werden vorhandene Istwerte anhand des historischen Saisonverlaufs bis zum aktuellen Datum hochgerechnet.",
    ...
    labels: {
      ...
      calibrationFactor: "Korrekturfaktor",
  ...
  en: {
    ...
    annualEstimateNote: "For incomplete years, available actual values are extrapolated to the full year using the historical seasonal pattern up to today.",
    ...
    labels: {
      ...
      calibrationFactor: "Correction factor",
